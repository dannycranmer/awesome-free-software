...
- [DevToolbox](https://dannycranmer.github.io/devtoolbox/) - Free browser-based developer tools including JWT decoder, Base64 encoder/decoder, JSON formatter, regex tester, and more. All processing happens client-side. ([MIT](https://github.com/dannycranmer/devtoolbox/blob/main/LICENSE))
...
- [ImageToolkit](https://dannycranmer.github.io/imagetoolkit/) - Free, privacy-first image tools (compress, resize, convert, crop). Runs entirely in the browser with no file uploads. ([MIT](https://github.com/dannycranmer/imagetoolkit/blob/main/LICENSE))
...
- [Parchment](https://dannycranmer.github.io/parchment/) - Free, privacy-first PDF tools (merge, split, compress, convert, watermark, sign). Runs entirely in the browser with no file uploads. ([MIT](https://github.com/dannycranmer/parchment/blob/main/LICENSE))
